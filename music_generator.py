...
REPLICATE_API_TOKEN = os.environ.get("REPLICATE_API_TOKEN", "r8_a6KaY8r8rvrmOEqm5CbPrkpB7O7qrMa2U9dfM")
...
def check_api_token():
    if not REPLICATE_API_TOKEN:
        ...
        print("Please set your API token using one of the following methods:")
        print("1. Set an environment variable:")
        print("   export REPLICATE_API_TOKEN=your_api_token_here")
        print("2. Or replace the REPLICATE_API_TOKEN variable in this script with your actual token.")
        sys.exit(1)
